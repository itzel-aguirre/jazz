...
<div class="container-fluid">
        ...
        <div class="card">
          <picture>
            <source
              ...
              srcset="https://placeimg.com/450/400/animals"
            />
            <img
              class="card-img-top"
              src="images/slider/mobile/abelMirales.jpg"
              alt="Card image cap"
            />
          </picture>
          <div class="card-body">
      ...
      <div class="item">
        <div class="card">
          <picture>
            <source
              media="(min-width: 1200px)"
              srcset="https://placeimg.com/450/400/nature"
            />
            <img
              class="card-img-top"
              src="images/slider/mobile/amy.jpg"
              alt="Card image cap"
            />
          </picture>
          <div class="card-body">
            <div class="artist-info">
              <p class="performer">
                ...
                >Homenaje a Amy Winehouse por Xiomara Méndez
              </p>
              <p class="genre">
      ...
      <div class="item">
        <div class="card">
          <picture>
            <source
              media="(min-width: 1200px)"
              srcset="https://placeimg.com/450/400/any"
            />
            <img
              class="card-img-top"
              src="images/slider/mobile/testCrosby.jpg"
              alt="Card image cap"
            />
          </picture>
          <div class="card-body">
      ...
      <div class="item">
        <div class="card">
          <picture>
            <source
              media="(min-width: 1200px)"
              srcset="https://placeimg.com/450/400/people"
            />
            <img
              class="card-img-top"
              src="images/slider/mobile/afrobeat.jpg"
              alt="Card image cap"
            />
          </picture>
          <div class="card-body">
      ...
      <div class="item">
        <div class="card">
          <picture>
            <source
              media="(min-width: 1200px)"
              srcset="https://placeimg.com/450/400/tech/sepia"
            />
            <img
              class="card-img-top"
              src="images/slider/mobile/NiteJewel.jpg"
              alt="Card image cap"
            />
          </picture>
          <div class="card-body">
  ...
  <div class="row">
    <div class="col-12 col-xl-6 mh-100 p-0">
      <div class="background-image background-image__second-image"></div>
    </div>
    <div class="col-12 col-xl-6 mh-100">
      <div class="row">
        <div class="col-6  col-xl-12 mh-100 p-0">
          <div
            class="background-image background-image__button background-image__button--food"
          >
            <a href="downloads/comida.pdf" target="_blank">Comida</a>
          </div>
        </div>
        <div class="col-6 col-xl-12 mh-100 p-0">
          <div
          ...
          >
            <a href="downloads/bebidas.pdf" target="_blank">Bebidas</a>
          </div>
        </div>
      </div>
    </div>
          ...
          <fieldset class="col-12 col-md-6 col-xl-5">
            <div class="form-group">
              ...
              <select id="show" class="form-control" required>
                ...
                <option value="saab"
                  >Homenaje a Amy Winehouse por Xiomara Méndez</option
                >
