...
<section class="container-fluid">
  <div class="row row--background-red justify-content-center">
    <div class="col-12 col-lg-6 ">
      <h1 class="title title--marginleft-less text-center">Términos de servicio</h1>
    </div>
  </div>
  <div class="container">
    <p class="subtitle">Información general</p>
    <p class="paragraph-legal">
    Este sitio web es operado por DOS CON TODO SA DE CV . En todo el sitio, los términos “nosotros”, “nos” y “nuestro” se refieren a DOS CON TODO SA DE CV . DOS CON TODO SA DE CV  ofrece este sitio web, incluyendo toda la información, herramientas y servicios disponibles para ti en este sitio, el usuario, está condicionado a la aceptación de todos los términos, condiciones, políticas y notificaciones aquí establecidos.
    </p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 1 - Términos de la tienda en línea</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 2 - Condiciones generales</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 3 - Exactitud, exhaustvidad y actualidad de la información</p>
    <p class="paragraph-legal">
    No nos hacemos responsables si la información disponible en este sitio no es exacta, completa o actual.  El material en este sitio es provisto solo para información general y no debe confiarse en ella o utilizarse como la única base para la toma de decisiones sin consultar, previamente, información más precisa, completa u oportuna.  Cualquier dependencia en el material de este sitio es bajo su propio riesgo.
    </p>
    <p class="paragraph-legal">
    ...
    <p class="paragraph-legal">Sección 4 - Modificaciones al servicio y precios</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 5 - Productos o servicios (si aplicable)</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 6 - Exactitud de facturación e información de cuenta</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 7 - Herramientas opcionales</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 8 - enlaces de terceras partes</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 9 - comentarios de usuario, captación y otros envíos</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 10 - Información personal</p>
    <p class="paragraph-legal">Tu presentación de información personal a través del sitio se rige por nuestra Política de Privacidad. Para ver nuestra Política de Privacidad.</p>
    <p class="subtitle">Sección 11 – Errores, inexactitudes y omisiones</p>
    <p class="paragraph-legal">
    ...
    <p class="paragraph-legal">
    En ningún caso DOS CON TODO SA DE CV , nuestros directores, funcionarios, empleados, afiliados, agentes, contratistas, internos, proveedores, prestadores de servicios o licenciantes serán responsables por cualquier daño, pérdida, reclamo, o daños directos, indirectos, incidentales, punitivos, especiales o consecuentes de cualquier tipo, incluyendo, sin limitación, pérdida de beneficios, pérdida de ingresos, pérdida de ahorros, pérdida de datos, costos de reemplazo, o cualquier daño similar, ya sea basado en contrato, agravio (incluyendo negligencia), responsabilidad estricta o de otra manera, como consecuencia del uso de cualquiera de los servicios o productos adquiridos mediante el servicio, o por cualquier otro reclamo relacionado de alguna manera con el uso del servicio o cualquier producto, incluyendo pero no limitado, a cualquier error u omisión en cualquier contenido, o cualquier pérdida o daño de cualquier tipo incurridos como resultados de la utilización del servicio o cualquier contenido (o producto) publicado, transmitido, o que se pongan a disposición a través del servicio, incluso si se avisa de su posibilidad.  Debido a que algunos estados o jurisdicciones no permiten la exclusión o la limitación de responsabilidad por daños consecuenciales o incidentales, en tales estados o jurisdicciones, nuestra responsabilidad se limitará en la medida máxima permitida por la ley.
    </p>
    <p class="subtitle">Sección 14 - Indemnización</p>
    <p class="paragraph-legal">
    Aceptas indemnizar, defender y mantener indemne DOS CON TODO SA DE CV  y nuestras matrices, subsidiarias, afiliados, socios, funcionarios, directores, agentes, contratistas, concesionarios, proveedores de servicios, subcontratistas, proveedores, internos y empleados, de cualquier reclamo o demanda, incluyendo honorarios razonables de abogados, hechos por cualquier tercero a causa o como resultado de tu incumplimiento de las Condiciones de Servicio o de los documentos que incorporan como referencia, o la violación de cualquier ley o de los derechos de u tercero.
    </p>
    <p class="subtitle">Sección 15 - Divisibilidad</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 16 - Rescisión</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 17 - Acuerdo completo</p>
    <p class="paragraph-legal">
    ...
    <p class="subtitle">Sección 18 - Ley</p>
    <p class="paragraph-legal">
    Estas Condiciones del servicio y cualquier acuerdos aparte en el que te proporcionemos servicios se regirán e interpretarán en conformidad con las leyes de Milán 14, Colonia Juárez, CDMX., , 06600 , México.
    </p>
    <p class="subtitle">Sección 19 - Cambios en los términos de servicio</p>
    <p class="paragraph-legal">Puedes revisar la versión más actualizada de los Términos de Servicio en cualquier momento en esta página.</p>
    <p class="paragraph-legal">Nos reservamos el derecho, a nuestra sola discreción, de actualizar, modificar o reemplazar cualquier parte de estas Condiciones del servicio mediante la publicación de las actualizaciones y los cambios en nuestro sitio web. Es tu responsabilidad revisar nuestro sitio web periódicamente para verificar los cambios. El uso continuo de o el acceso a nuestro sitio Web o el Servicio después de la publicación de cualquier cambio en estas Condiciones de servicio implica la aceptación de dichos cambios.</p>
    <p class="subtitle">Sección 20 - Información de contacto</p>
    <p class="paragraph-legal">Preguntas acerca de los Términos de Servicio deben ser enviadas a parkerandlenox@gmail.com.</p>
  </div>
</section>
